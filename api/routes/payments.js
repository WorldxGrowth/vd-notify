...
// Helper — add credits + log + email (used by both polling and webhook)
...
// GET /api/payments/check/:payment_id — poll RazCrypto status directly
...
// GET /api/payments/status/:payment_id — DB status
...
router.post('/webhook', async (req, res) => {
    try {
        ...
        if (expected !== signature) {
            ...
            // Not rejecting — polling handles credits anyway
        } else {
